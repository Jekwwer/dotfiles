...
This file is based on [github/gitignore/VisualStudio.gitignore][visualstudio.gitignore] accumulating best practices and includes patterns for:
...
### Usage:
1. Save the `.gitmessage` file to your home directory:
   ```bash
